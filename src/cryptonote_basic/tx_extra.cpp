...
tx_extra_selam_name_system tx_extra_selam_name_system::make_buy(
...
{
  tx_extra_selam_name_system result{};
...
tx_extra_selam_name_system tx_extra_selam_name_system::make_renew(
...
tx_extra_selam_name_system tx_extra_selam_name_system::make_update(
