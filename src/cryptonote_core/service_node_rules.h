...
namespace service_nodes {
  ...
  inline constexpr uint64_t MINIMUM_OPERATOR_PORTION = cryptonote::old::STAKING_PORTIONS / selam::MAX_CONTRIBUTORS_V1;
...
// return: UINT64_MAX if (num_contributions > the max number of contributions), otherwise the amount in selam atomic units
