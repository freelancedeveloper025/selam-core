...
#define SELAM_DEFAULT_LOG_CATEGORY "uptime_proof"
...
selamc::bt_dict Proof::bt_encode_uptime_proof() const
{
  selamc::bt_dict encoded_proof{
    //version
    {"v", selamc::bt_list{{version[0], version[1], version[2]}}},
    //timestamp
    {"t", timestamp},
    //public_ip
    ...
    //storage_version
    {"sv", selamc::bt_list{{storage_server_version[0], storage_server_version[1], storage_server_version[2]}}},
    //lokinet_version
    {"lv", selamc::bt_list{{lokinet_version[0], lokinet_version[1], lokinet_version[2]}}},
  };
